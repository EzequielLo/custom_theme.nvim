...
local highlights = {
  ...
  --{ hg = 'String', fg = colors.constant }, --a string constant: "this is a string"
  ...
  { hg = 'Identifier', fg = colors.constant }, --any variable name
 -- { hg = 'Function', fg = colors.function}, --function name (also: methods for classes)
  ...
  --{ hg = 'StorageClass', fg = colors.function }, --static, register, volatile, etc.
  ...
  { hg = 'Cursor', fg = colors.cursor}, --the character under the cursor
  --{ hg = 'CursorIM' }, --like Cursor, but used when in IME mode
  { hg = 'CursorLine', bg = colors.cursorline }, --the screen line that the cursor is in when 'cursorline' is set
 ...
 -- { hg = 'Folded', fg = colors.comment_grey }, --line used for closed folds
  ...
  { hg = 'LineNr', fg = colors.cursorline }, --Line number for " =number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
  ...
  { hg = 'NonText', fg = colors.cursor }, --'~' and '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line).
  ...
  { hg = 'SpellCap', fg = colors.white }, --Word that should start with a capital. This will be combined with the highlighting used otherwise.
  { hg = 'SpellLocal', fg = colors.white }, --Word that is recognized by the spellchecker as one that is used in another region. This will be combined with the highlighting used otherwise.
  { hg = 'SpellRare', fg = colors.white }, --Word that is recognized by the spellchecker as one that is hardly ever used. spell This will be combined with the highlighting used otherwise.
  { hg = 'StatusLine', fg = colors.white, bg = colors.cursor }, --status line of current window
  ...
  { hg = 'StatusLineTerm', fg = colors.white, bg = colors.cursor }, --status line of current :terminal window
  ...
  --{ hg = 'Visual', bg = colors.cursos }, --Visual mode selection
  --{ hg = 'VisualNOS', bg = colors.curos }, --Visual mode selection when vim is "Not Owning the Selection". Only X11 Gui's gui-x11 and xterm-clipboard supports this.
  ...
  { hg = 'DiagnosticHint', fg = colors.white },
  ...
  { hg = 'DiagnosticUnderlineHint', fg = colors.white, gui = 'underline', cterm = 'underline' },
...
--  { hg ="cssClassName", fg= colors.white },
--  { hg ="cssClassNameDot", fg= colors.white },
--  { hg ="cssDefinition", fg= colors.purple },
--  { hg ="cssFontAttr", fg= colors.white },
...
--  { hg ="cssMediaType", fg= colors.white },
--  { hg ="cssProp", fg= colors.white },
--  { hg ="cssPseudoClassId", fg= colors.white },
--  { hg ="cssSelectorOp", fg= colors.purple },
--  { hg ="cssSelectorOp2", fg= colors.purple },
--  { hg ="cssTagName", fg= colors.dark_red },

-- HTML (keep consistent with Markdown, below)
--  { hg ="htmlArg", fg= colors.white },
--  { hg ="htmlBold", fg= colors.white, gui= "bold", cterm= "bold" },
...
--  { hg ="htmlSpecialChar", fg= colors.white },
...
--  { hg ="javaScriptNull", fg= colors.red },
--  { hg ="javaScriptNumber", fg= colors.red },
...
--  { hg ="jsonBoolean", fg= colors.white },
--  { hg ="jsonNumber", fg= colors.white },
...
--  { hg ="markdownBold", fg= colors.white, gui= "bold", cterm= "bold" },
...
--  { hg ="markdownUrl", fg= colors.cyan, gui= "underline", cterm= "underline" },
  ...
  --{ hg =  "TSConstBuiltin" , fg = colors.white},
  ...
  --{ hg =  "TSTypeBuiltin " , fg = colors.red, gui="bold"},
  ...
  --ts_rainbow
	...
	-- { hg = 'rainbowcol4', fg = colors.white, bg = colors.none },
