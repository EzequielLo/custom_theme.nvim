...
local highlights = {
  ...
  { hg = 'GitSignsDelete', fg = colors.red },
    ...
    -- LspTrouble
  { hg = 'LspTroubleText', fg = colors.foreground },
  { hg = 'LspTroubleCount', fg = colors.red, bg=colors.gutter_fg_grey },
  { hg = 'LspTroubleNormal', fg = colors.yellow, bg=colors.menu_grey },

    -- typescript
--	{ hg = "typescriptTSType" , fg = colors. },
--  { hg = "typescriptTSConstructor" , fg = colors.},
--  { hg = "typescriptTSTypeBuiltin" , fg = colors.},
...
--  { hg =  "TSDanger" , fg = colors.bg, bg=colors.error},
 ...
 -- { hg =  "TSNumber" , fg = colors.purple},
  ...
  { hg =  "TSStringRegex" , fg = colors.orange},
  ...
  { hg =  "TSTypeBuiltin " , fg = colors.orange},
  --{ hg =  "TSTypeDefinition" , fg = colors},
  --{ hg =  "TSTypeQualifier" , fg = colors.cyan},
  { hg =  "TSVariable" , fg = colors.foreground},
  { hg =  "TSVariableBuiltin", fg = colors.red},
  { hg =  'TSTag', fg = colors.red},
 -- { hg =  'TSTagAttribute', fg = colors.},
  { hg =  'TSPunctDelimiter', fg = colors.white},
  { hg =  "TSTitle " , fg = colors.orange, gui="bold"},
  ...
  { hg =  'TSTextReference ', fg = colors.red},
  	...
  	--ts_rainbow
	 { hg = 'rainbowcol1', fg = colors.grey, bg = colors.none },
